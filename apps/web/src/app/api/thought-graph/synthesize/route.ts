...
5. 마크다운 기호(예: #, ##, ###, **, *, _, - 등)는 절대 사용하지 마십시오. 소제목이나 구분선이 필요한 경우 일반 줄바꿈(엔터)과 공백, 그리고 한글 문장 부호만을 활용하여 가독성을 확보한 순수 평문(Plain Text) 형태로 작성하십시오. 인사말이나 부연 설명 없이 '오직 최종 합성 본문'만 반환해야 합니다.`
