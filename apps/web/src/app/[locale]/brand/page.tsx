...
import { motion, useScroll, useTransform, useSpring, AnimatePresence, useInView, useMotionTemplate, useVelocity, useMotionValue } from 'framer-motion'
...
export default function BrandShowroomPage() {
  ...
  const magneticX = useTransform(mouseX, [-1, 1], [-20, 20])
  const magneticY = useTransform(mouseY, [-1, 1], [-20, 20])
